...
import com.karutakanji.TelaInicialMultiplayer;
...
public class MyCustomAdapter extends ArrayAdapter<CategoriaDeKanjiParaListviewSelecionavel> {
	  ...
	  private TelaInicialMultiplayer telaMultiplayer; //precisaremos dela na hora de um jogador escolher uma categoria para mandar uma reliable message p o outro
	  
	  public MyCustomAdapter(Context context, int textViewResourceId,
	    ArrayList<CategoriaDeKanjiParaListviewSelecionavel> categoriaDeKanjiList, boolean usuarioPodeEscolherCategorias,TelaInicialMultiplayer telaMultiplayer) {
	   ...
	   this.telaMultiplayer = telaMultiplayer;
	  }
	    ...
	    holder.name.setOnClickListener( new View.OnClickListener() { 
	     ...
	     { 
	    	 if(usuarioPodeEscolherCategorias == true)
	    	 {
	   	      ...
	   	      telaMultiplayer.mandarMensagemMultiplayer("categoria=" + categoriaDeKanji.getName() + ";" + "enabled=" + categoriaDeKanji.isSelected());
